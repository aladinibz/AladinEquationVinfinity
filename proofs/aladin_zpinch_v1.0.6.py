# mega ultra maniac v1.0.6 – FULL COLAB PRO READY VERSION
# ALL 5 VALIDATIONS + ALL PLOTS + HEATING/COOLING + GPU SUPPORT
# Copy-paste into one cell and run – let's publish this shit!

# Install packages
!pip install --upgrade "jax[cuda12_pip]" -q
...
print("JAX devices (Pro GPU should show here):", jax.devices())
!nvidia-smi  # show GPU info

os.makedirs("plots", exist_ok=True)

# ────────────────────────────────────────────────
# CONFIG – full original settings
# ────────────────────────────────────────────────
CONFIG = {
    'grid_size': 128,
    'cfl': 0.3,
