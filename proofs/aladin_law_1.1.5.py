"""
ALADIN v1.1.5 — Relativistic Jet Spine + Radial Profiles (Fixed)
"""
...
print("🚀 ALADIN v1.1.5 — Fixed Version\n")
...
c = 3.0e8
m_e = 9.109e-31
gamma_ad = 5.0/3          # adiabatic index

GAMMA_BULK = 5.0          # ← Change this (1.0 = non-rel, 5+ = relativistic jet)
...
plt.title(f'Relativistic Jet Spine (γ = {GAMMA_BULK})')
plt.legend()
plt.grid(alpha=0.3)
plt.show()
