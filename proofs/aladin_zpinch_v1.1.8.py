# mega ultra maniac v1.1.8 – FULL NO-GAPS COLAB-READY PUBLISH VERSION
# Complete code: 3D resistive MHD Z-pinch + sausage/kink m=0–4 fits + helical fits + all validations + integration tests
