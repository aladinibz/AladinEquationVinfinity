...
print("🌌 ALADIN Plasma Cosmology v0.5 — Pure Cell-Centered Safe Version")
...
for step in range(steps):
    ...
    fast_speed = cp.sqrt((gamma * ((E_total - 0.5*rho*(vx**2+vy**2+vz**2) - 0.5*B2 - u_cr)/(gamma-1.0)) + B2) / rho)
