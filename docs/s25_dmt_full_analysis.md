# S25-DMT Breakthrough – Complete Proof Suite (12 Visualizations)
...
## Plots (in /plots/)
- s25_dmt_fluctuation_functions.png  
- s25_dmt_hq_curve.png  
- s25_dmt_singularity_spectrum.png  
- s25_dmt_delta_alpha_timecourse.png  
- s25_dmt_delta_alpha_gamma_43vs40.png  
- s25_dmt_delta_alpha_aaft_surrogate.png  
- s25_dmt_gamma43_aaft_surrogate.png  
- s25_dmt_gamma40_aaft_surrogate.png  
- s25_dmt_delta_alpha_pre_post_ci.png  
- s25_dmt_gamma43_pre_post_ci.png  
- s25_dmt_psd_pre_post.png  
- s25_dmt_zscore_histogram.png  
...
Script: s25_dmt_full_analysis.py
