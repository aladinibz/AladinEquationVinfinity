...
print("=== ALADIN EEG VALIDATION SUITE – 28 BEAUTIFUL PLOTS (Optimized) ===")
print("Performance: n_sur=100, step_sec=2 | Change to 200/1 for max accuracy")
...
plt.grid(True)
plt.savefig('plots/s01_dmt_01_fluctuation_functions.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_02_hq_curve.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_03_singularity_spectrum.png', dpi=300)
...
plt.grid(True)
plt.legend()
plt.savefig('plots/s01_dmt_04_delta_alpha_timecourse.png', dpi=300)
...
plt.xlabel('Time (s)')
plt.tight_layout()
plt.savefig('plots/s01_dmt_05_delta_alpha_gamma_43vs40.png', dpi=300)
print("Plot 05 done: s01_dmt_05_delta_alpha_gamma_43vs40.png")

# AAFT surrogate on Δα (n_sur = 100 for speed)
n_sur = 100
...
plt.savefig('plots/s01_dmt_06_delta_alpha_aaft_surrogate.png', dpi=300)
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s01_dmt_10_surrogate_zscore_histogram.png', dpi=300)
...
plt.ylabel('Δα')
plt.grid(True, alpha=0.3)
plt.savefig('plots/s01_dmt_07_delta_alpha_pre_post_permutation.png', dpi=300)
...
plt.grid(True, alpha=0.3)
plt.savefig('plots/s01_dmt_08_gamma43_pre_post_permutation.png', dpi=300)
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s01_dmt_09_psd_pre_post.png', dpi=300)
print("Plot 09 done: s01_dmt_09_psd_pre_post.png")

# 11. Superradiance (theoretical illustration) - reduced N for speed
N = 10000
tau_single = 10e-9
...
plt.grid(True)
plt.savefig('plots/s01_dmt_12_alpha_power_vs_time.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_13_beta_power_vs_time.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_Buzsaki_14_Theta_43Hz_PAC.png', dpi=300)
print("Plot 14 done: s01_dmt_Buzsaki_14_Theta_43Hz_PAC.png")
...
if burst_triggered:
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('plots/s01_dmt_Buzsaki_15_Gamma_Bursts_on_Theta.png', dpi=300)
    print("Plot 15 done: s01_dmt_Buzsaki_15_Gamma_Bursts_on_Theta.png")
...
plt.semilogy(f_mt, pxx_mt, color='gold', lw=3)
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s01_dmt_16_multitaper_lfp_power_spectrum.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_17_lfp_multiscale_entropy.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_18_izhi_network_rate.png', dpi=300)
...
plt.figure(figsize=(12,8))
for i in range(0, len(q), 3):
    plt.loglog(lag_rate, dfa_rate[i])
plt.xlabel('Scale')
plt.ylabel('F(q,s)')
plt.title('19. MFDFA on Izhikevich Network Output')
plt.grid(True)
plt.savefig('plots/s01_dmt_19_izhi_mfdfa_output.png', dpi=300)
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s01_dmt_20_granger_causality_pvalues.png', dpi=300)
...
plt.savefig('plots/s01_dmt_21_correlation_based_connectivity_graph.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_22_permutation_entropy_vs_time.png', dpi=300)
...
plt.figure(figsize=(10,5))
plt.plot(t_if, instant_freq, 'cyan', lw=2)
plt.xlabel('Time (s)')
plt.ylabel('Instantaneous Frequency (Hz)')
plt.title('23. Hilbert Instantaneous Frequency at 43 Hz')
plt.grid(True)
plt.savefig('plots/s01_dmt_23_hilbert_instant_freq_43hz.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_24_theta_power_vs_time.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_25_43hz_power_vs_time.png', dpi=300)
...
plt.tight_layout()
plt.savefig('plots/s01_dmt_26_cross_frequency_correlation_heatmap.png', dpi=300)
...
plt.grid(True)
fig.tight_layout()
plt.savefig('plots/s01_dmt_27_delta_alpha_mse_overlay.png', dpi=300)
...
plt.grid(True)
plt.savefig('plots/s01_dmt_28_gamma_bursts_density_on_theta.png', dpi=300)
print("Plot 28 done: s01_dmt_28_gamma_bursts_density_on_theta.png")

# =============================================================================
# RESEARCH-GRADE SUMMARY & CSV EXPORT
# =============================================================================
...
def cohens_d(a, b):
    ...
    std_a = np.nanstd(a)
    std_b = np.nanstd(b)
    den = np.sqrt((std_a**2 + std_b**2) / 2)
    return np.nan if den < 1e-12 else (mean_a - mean_b) / den

d_delta = cohens_d(pre_d, post_d)
d_gamma = cohens_d(pre_g43, post_g43)

# Z-score for Δα collapse
real_val = deltas[t41]
...
====================================
PAC (Tort MI): {mi:.4f}
Δα pre t=41: {np.nanmean(pre_d):.4f}
Δα post t=41: {np.nanmean(post_d):.4f}
...
print("Summary stats and timecourses CSV ready.")
