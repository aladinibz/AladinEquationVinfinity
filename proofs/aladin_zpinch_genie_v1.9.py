...
GRID_SIZE = 128
MAX_STEPS = 500000         # back to 500k – proven stable length
dt_max    = 1.2e-4
CFL       = 0.75

print("🚀 ALADIN v1.9 – 500k steps – STABLE SYMMETRY BREAKER")
print("Bessel J₀(kr) + m=1–8 kink seed + zero diffusion + strong backreaction")
