...
# ================== CONFIG ==================
CONFIG = {
    'n_sur': 200,          # As you asked — full 200 surrogates
    'step_sec': 4,
    'window_sec': 5,
    'fs': 128,
...
# AAFT surrogate on Δα — OPTIMIZED WITH PARALLEL JOBLIB + TQDM PROGRESS BAR
n_sur = CONFIG['n_sur']
...
# 17. True Multiscale Sample Entropy — LIGHT VERSION FOR COLAB RAM
...
def multiscale_sample_entropy(x, max_scale=8, m=2):
    mse = []
...
# Heavy downsampling for MSE to save RAM
signal_mse = signal[::8]   # 16 Hz — more than enough for entropy
...
plt.title('17. True Multiscale Sample Entropy of LFP (light version)')
plt.grid(True)
