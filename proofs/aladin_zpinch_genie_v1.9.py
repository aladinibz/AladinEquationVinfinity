...
GRID_SIZE = 128
MAX_STEPS = 900000         # 900k steps – overnight push
dt_max    = 1.2e-4
CFL       = 0.75

print("🚀 ALADIN v1.9 – 900k steps – SYMMETRY BREAKER NIGHT RUN")
print("Bessel J₀(kr) + multi-mode kink seed + zero diffusion + strong backreaction")
...
# Multi-mode kink seed (m=1–8, mild amplitude) – symmetry breaker
m_kink = [1, 2, 3, 5, 8]
for m in m_kink:
...
# Histories – DOWNSAMPLE every 500 steps to save RAM
...
progress_bar = tqdm(total=MAX_STEPS, desc="ALADIN v1.9 – 1M steps – MEMORY SAFE")
...
try:
    while t < t_max and step < MAX_STEPS:
        ...
        # ... (J, v update, rho, p, T, fermion, genie, C_field, clipping – same as before) ...

        # Downsample history every 500 steps
