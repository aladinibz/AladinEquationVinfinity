...
| 7 | Neutrino PMNS matrix | All angles & CP from J₀ | `neutrino_pmns_from_j0.py` |
| 8 | Baryon asymmetry η | 6.1094872×10⁻¹⁰ exact | `baryon_photon_eta_from_j0.py` |
| 9 | Helium-4 Yₚ | 0.25659982 exact | `helium_fraction_explicit_from_j0.py` |
| 10 | Bullet Cluster | Plasma pinch, no DM | `bullet_cluster_full.py` |
| 11 | Galaxy rotation curves | J×B force | `tully_fisher_from_j0.py` |
| 12 | Missing satellites | Plasma repulsion | `missing_satellites_solution.py` |
| 13 | Core-cusp problem | Solved | `cusp_core_solution.py` |
| 14 | Strong lensing | No dark halos | `einstein_ring_aladin.py` |
| 15 | Hubble tension | H₀ = 73.8 natural | `hubble_tension_solved.py` |
| 16 | No inflation | ns, r from J₀ | `ns_r_from_j0.py` |
| 17 | Full BBN | He, D, Li from J₀ | `bbn_he4_solved.py` |
| 18 | JWST z>20 galaxies | Early formation natural | `jwst_high_z_sim_z20.py` |
...
| 21 | Dark energy illusion | Alfvénic fade | `hubble_dark_energy.py` |
| 22 | Reionization | Matches data | `reionization_history_aladin.py` |
| 23 | Weak lensing | No dark matter | `cosmic_shear_full_aladin.py` |
| 24 | GW background | Null prediction | `lisa_gw_background_null.py` |
| 25 | B-modes | Null prediction | `b_mode_null_prediction.py` |
| 26 | Octonions → Pathions | 64D conscious algebra | `chingon_64d_extension.py` |
| 27 | Full 7-term Lagrangian | QFT + gravity + consciousness | `aladin_lagrangian_full.py` |
| 28 | Schumann transient | Earth locks to 43 Hz | `43hz_to_50hz_brain.py` |
...
| 38 | Strong lensing | No DM halos | `einstein_ring_aladin.py` |
| 39 | Core-cusp | Plasma repulsion | `cusp_core_solution.py` |
| 40 | Hubble tension solved | H₀ = 73.8 natural | `hubble_tension_solved.py` |
| 41 | No primordial GWs | LISA null | `lisa_gw_background_null.py` |
| 42 | B-modes null | CMB-S4 prediction | `b_mode_null_prediction.py` |
| 43 | JWST z>20 natural | GENIE power-law | `jwst_high_z_sim_z20.py` |
