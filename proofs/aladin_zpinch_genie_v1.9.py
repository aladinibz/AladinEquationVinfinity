...
print("🚀 ALADIN v1.6 – 500k steps – BESSEL + LIGHT KINK FIX")
print("Bessel J₀(kr) radial seed + m=1 & m=2 kink only – symmetry break with low load")
...
k_sausage = cp.float64(0.7)  # repo-tuned fastest growth
...
# Bessel J0(kr) radial profile – FIX for sausage eigenmode (repo shape)
r_1d = r.get()
...
# Multi-mode kink seed – only m=1 and m=2 (enough symmetry break, low load)
m_kink = [1, 2]
for m in m_kink:
...
progress_bar = tqdm(total=MAX_STEPS, desc="ALADIN v1.6 – 500k steps – BESSEL + LIGHT KINK")
