...
# ====================== VECTORIZED EMF KERNEL ======================
def compute_emfs(vx, vy, vz, Bx, By, Bz, dx):
    """Fully vectorized EMF calculation - all 3 edges"""
    N = vx.shape[0]
    
    Emfx = np.zeros((N, N+1, N+1))
    Emfy = np.zeros((N+1, N, N+1))
    Emfz = np.zeros((N+1, N+1, N))
...
print("Vectorized True CT Yee Running...\n")
...
print("\nVectorized True CT Yee simulation finished.")
