...
raw.pick(picks='eeg')  # Modern MNE way
...
lag_rate = lag_rate[:dfa_rate.shape[1]]  # CRITICAL FIX for Plot 27
plt.figure(figsize=(11,6.5))
...
print("\n✅ 100% COMPLETE — Plot 27 FIXED, NO MISSING CODE")
