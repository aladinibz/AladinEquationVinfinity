...
print("=== ALADIN S04-DMT VALIDATION SUITE – 30 BEAUTIFUL PLOTS ===")

# S04 direct download
file_name = "s04-DMT.bdf"
url = "https://raw.githubusercontent.com/aladinibz/AladinEquationVinfinity/main/data/raw_bdf/s04-DMT.bdf"
...
plt.grid(True)
plt.savefig('plots/s04_dmt_01_fluctuation_functions.png', dpi=600)
print("Plot 01 done: s04_dmt_01_fluctuation_functions.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_02_hq_curve.png', dpi=600)
print("Plot 02 done: s04_dmt_02_hq_curve.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_03_singularity_spectrum.png', dpi=600)
print("Plot 03 done: s04_dmt_03_singularity_spectrum.png")
...
plt.title('04. Δα Collapse (S04-DMT)')
plt.xlabel('Time (s)')
plt.ylabel('Δα')
plt.grid(True)
plt.legend()
plt.savefig('plots/s04_dmt_04_delta_alpha_timecourse.png', dpi=600)
print("Plot 04 done: s04_dmt_04_delta_alpha_timecourse.png")
...
plt.title('05. Δα vs Gamma (S04-DMT)')
plt.xlabel('Time (s)')
plt.tight_layout()
plt.savefig('plots/s04_dmt_05_delta_alpha_gamma_43vs40.png', dpi=600)
print("Plot 05 done: s04_dmt_05_delta_alpha_gamma_43vs40.png")
...
plt.axvline(t_peak_precise, c='red', ls='--', lw=3, label=f't≈{t_peak_precise:.6f} s')
plt.text(t_peak_precise + 0.5, max(deltas)*0.9, f"t_peak = {t_peak_precise:.6f} s", color='gold', fontsize=12, fontweight='bold')
plt.title('06. AAFT Surrogate Test (S04-DMT)')
plt.xlabel('Time (s)')
plt.ylabel('Δα')
plt.legend(fontsize=10)
plt.grid(True, alpha=0.3)
plt.savefig('plots/s04_dmt_06_delta_alpha_aaft_surrogate.png', dpi=600)
print("Plot 06 done: s04_dmt_06_delta_alpha_aaft_surrogate.png")
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s04_dmt_10_surrogate_zscore_histogram.png', dpi=600)
print("Plot 10 done: s04_dmt_10_surrogate_zscore_histogram.png")
...
plt.ylabel('Δα')
plt.grid(True, alpha=0.3)
plt.savefig('plots/s04_dmt_07_delta_alpha_pre_post_permutation.png', dpi=600)
print("Plot 07 done: s04_dmt_07_delta_alpha_pre_post_permutation.png")
...
plt.grid(True, alpha=0.3)
plt.savefig('plots/s04_dmt_08_gamma43_pre_post_permutation.png', dpi=600)
print("Plot 08 done: s04_dmt_08_gamma43_pre_post_permutation.png")
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s04_dmt_09_psd_pre_post.png', dpi=600)
print("Plot 09 done: s04_dmt_09_psd_pre_post.png")
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('plots/s04_dmt_11_superradiance_mt_disorder.png', dpi=600)
print("Plot 11 done: s04_dmt_11_superradiance_mt_disorder.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_12_alpha_power_vs_time.png', dpi=600)
print("Plot 12 done: s04_dmt_12_alpha_power_vs_time.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_13_beta_power_vs_time.png', dpi=600)
print("Plot 13 done: s04_dmt_13_beta_power_vs_time.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_14_buzsaki_theta_43hz_pac.png', dpi=600)
print("Plot 14 done: s04_dmt_14_buzsaki_theta_43hz_pac.png")
...
if burst_triggered:
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('plots/s04_dmt_15_buzsaki_gamma_bursts_on_theta.png', dpi=600)
    print("Plot 15 done: s04_dmt_15_buzsaki_gamma_bursts_on_theta.png")
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s04_dmt_16_multitaper_lfp_power_spectrum.png', dpi=600)
print("Plot 16 done: s04_dmt_16_multitaper_lfp_power_spectrum.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_17_lfp_multiscale_entropy.png', dpi=600)
print("Plot 17 done: s04_dmt_17_lfp_multiscale_entropy.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_18_izhi_network_rate.png', dpi=600)
print("Plot 18 done: s04_dmt_18_izhi_network_rate.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_19_izhi_mfdfa_output.png', dpi=600)
print("Plot 19 done: s04_dmt_19_izhi_mfdfa_output.png")
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s04_dmt_20_granger_causality_pvalues.png', dpi=600)
print("Plot 20 done: s04_dmt_20_granger_causality_pvalues.png")
...
plt.savefig('plots/s04_dmt_21_correlation_based_connectivity_graph.png', dpi=600)
print("Plot 21 done: s04_dmt_21_correlation_based_connectivity_graph.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_22_permutation_entropy_vs_time.png', dpi=600)
print("Plot 22 done: s04_dmt_22_permutation_entropy_vs_time.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_23_hilbert_instant_freq_43hz.png', dpi=600)
print("Plot 23 done: s04_dmt_23_hilbert_instant_freq_43hz.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_24_theta_power_vs_time.png', dpi=600)
print("Plot 24 done: s04_dmt_24_theta_power_vs_time.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_25_43hz_power_vs_time.png', dpi=600)
print("Plot 25 done: s04_dmt_25_43hz_power_vs_time.png")
...
plt.tight_layout()
plt.savefig('plots/s04_dmt_26_cross_frequency_correlation_heatmap.png', dpi=600)
print("Plot 26 done: s04_dmt_26_cross_frequency_correlation_heatmap.png")
...
plt.grid(True)
fig.tight_layout()
plt.savefig('plots/s04_dmt_27_delta_alpha_mse_overlay.png', dpi=600)
print("Plot 27 done: s04_dmt_27_delta_alpha_mse_overlay.png")
...
plt.grid(True)
plt.savefig('plots/s04_dmt_28_gamma_bursts_density_on_theta.png', dpi=600)
print("Plot 28 done: s04_dmt_28_gamma_bursts_density_on_theta.png")
...
plt.grid(True, alpha=0.3)
fig.tight_layout()
plt.savefig('plots/s04_dmt_29_delta_alpha_gamma_pre_post_summary.png', dpi=600)
print("Plot 29 done: s04_dmt_29_delta_alpha_gamma_pre_post_summary.png")
...
plt.tight_layout()
plt.savefig('plots/s04_dmt_30_summary_visual.png', dpi=600)
print("Plot 30 done: s04_dmt_30_summary_visual.png")
...
summary = f"""ALADIN S04-DMT Validation Summary
====================================
PAC (Tort MI): {mi:.4f}
...
with open('plots/s04_dmt_summary_stats.txt', 'w') as f:
    f.write(summary)

print("Summary stats saved: s04_dmt_summary_stats.txt")
...
timecourses.to_csv('plots/s04_dmt_timecourses.csv', index=False)
print("Timecourses CSV saved: s04_dmt_timecourses.csv")

# PDF with S04 name
print("\n=== GENERATING PROFESSIONAL PDF REPORT ===")

plot_dir = 'plots'
plot_files = sorted([f for f in os.listdir(plot_dir) if f.startswith('s04_dmt_') and f.endswith('.png')])

plot_captions = {
    's04_dmt_01_fluctuation_functions.png': f'Full-signal MF-DFA fluctuation functions across q orders (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_02_hq_curve.png': f'MF-DFA generalized Hurst exponent h(q) curve showing multifractality (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_03_singularity_spectrum.png': f'MF-DFA singularity spectrum f(α) – width indicates multifractal strength (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_04_delta_alpha_timecourse.png': f'Time-resolved Δα collapse with objective peak at {t_peak_precise:.6f} s',
    's04_dmt_05_delta_alpha_gamma_43vs40.png': f'Δα collapse aligned with 40–50 Hz gamma power (peak at {t_peak_precise:.6f} s)',
    's04_dmt_06_delta_alpha_aaft_surrogate.png': f'AAFT surrogate test with objective peak at {t_peak_precise:.6f} s',
    's04_dmt_10_surrogate_zscore_histogram.png': f'Surrogate distribution of Δα at peak time (real value marked, t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_07_delta_alpha_pre_post_permutation.png': f'Δα pre vs post t≈{t_peak_precise:.6f} s with permutation test',
    's04_dmt_08_gamma43_pre_post_permutation.png': f'Gamma 40–50 Hz power pre vs post t≈{t_peak_precise:.6f} s with permutation test',
    's04_dmt_09_psd_pre_post.png': f'Power spectral density pre vs post t≈{t_peak_precise:.6f} s switch',
    's04_dmt_11_superradiance_mt_disorder.png': f'Microtubule Superradiance Coherence Driven by 43 Hz Gamma (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_12_alpha_power_vs_time.png': f'Alpha (8–12 Hz) power timecourse (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_13_beta_power_vs_time.png': f'Beta (12–30 Hz) power timecourse (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_14_buzsaki_theta_43hz_pac.png': f'Buzsáki-style theta–43 Hz phase-amplitude coupling (Tort MI) (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_15_buzsaki_gamma_bursts_on_theta.png': f'Gamma bursts locked to theta cycles (Buzsáki canonical) (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_16_multitaper_lfp_power_spectrum.png': f'Welch LFP power spectrum showing 43 Hz peak (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_17_lfp_multiscale_entropy.png': f'True multiscale sample entropy of LFP signal (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_18_izhi_network_rate.png': f'Izhikevich spiking network driven by observed 43 Hz gamma (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_19_izhi_mfdfa_output.png': f'MF-DFA applied to Izhikevich network output (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_20_granger_causality_pvalues.png': f'Granger causality pineal → frontal with FDR correction (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_21_correlation_based_connectivity_graph.png': f'Correlation-based EEG connectivity graph (no self-loops) (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_22_permutation_entropy_vs_time.png': f'Permutation entropy timecourse (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_23_hilbert_instant_freq_43hz.png': f'Instantaneous frequency of 43 Hz gamma component (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_24_theta_power_vs_time.png': f'Theta (4–8 Hz) power timecourse (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_25_43hz_power_vs_time.png': f'43 Hz gamma power timecourse (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_26_cross_frequency_correlation_heatmap.png': f'Cross-frequency power correlation heatmap (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_27_delta_alpha_mse_overlay.png': f'Overlay of Δα and multiscale entropy timecourses (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_28_gamma_bursts_density_on_theta.png': f'2D density of gamma amplitude on theta phase (t_peak ≈ {t_peak_precise:.6f} s)',
    's04_dmt_29_delta_alpha_gamma_pre_post_summary.png': f'Δα and gamma power pre vs post t≈{t_peak_precise:.6f} s with Cohen’s d and p-values',
    's04_dmt_30_summary_visual.png': f'Research-grade summary: Δα collapse & gamma power with surrogate band and objective peak at {t_peak_precise:.6f} s'
}

with open(os.path.join(plot_dir, 's04_dmt_summary_stats.txt'), 'r') as f:
    summary_text = f.read()

pdf_path = os.path.join(plot_dir, 'S04_DMT_Validation_Report.pdf')
with PdfPages(pdf_path) as pdf:
    plt.figure(figsize=(8.5, 11))
    plt.text(0.5, 0.7, "ALADIN EEG Validation Suite – S04-DMT", fontsize=24, ha='center')
...
print(f"PDF report generated: S04_DMT_Validation_Report.pdf (with t_peak in ALL captions)")

print("\nAll 30 beautiful validations complete for S04!")
print("All plots saved with s04_dmt_ prefix.")
