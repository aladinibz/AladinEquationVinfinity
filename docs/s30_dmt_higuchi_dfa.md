# S30-DMT: Higuchi FD & DFA Collapse
...
(S30-DMT.bdf: high-dose inhaled N,N-DMT session). Sharp complexity collapse post-t=41 s switch — ego turbulence to ordered condensate at 43 Hz resonance.

### Interpretation
- High HFD/DFA: Chaotic ego state (Kolmogorov turbulence)  
- Drop post-41 s: Order & coherence (Fröhlich condensate)  
Adds statistical power with more breakthrough data.

### Plot
![S30-DMT Higuchi DFA](s30_dmt_higuchi_dfa.png)

**See also:**  
- s31_dmt_higuchi_dfa.md  
- s32_dmt_higuchi_dfa.md  
