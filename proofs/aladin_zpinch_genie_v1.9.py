...
GRID_SIZE = 128
MAX_STEPS = 700000         # 700k – balanced overnight
dt_max    = 1.2e-4
CFL       = 0.75

print("🚀 ALADIN v1.9 FIXED – 700k steps – ULTRA MEMORY SAFE")
print("No history append first 5000 steps + downsample every 2000 + RAM monitor")
...
# Histories – DOWNSAMPLE every 2000 steps + skip first 5000
