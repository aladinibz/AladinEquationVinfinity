...
print("🌌 Plasma Cosmology v7.3 — 128³ A100 GPU + J×B Radial Force Profile Analysis")
...
def run_simulation(use_dm, use_cr=True):
    ...
    for step in range(steps):
        ...
        # Radial J×B acceleration (the key term for your hypothesis)
    ...
    # J × B radial acceleration profile
    a_JxB_r = (JxB_x * (X / r_cyl) + JxB_y * (Y / r_cyl)) / (rho + 1e-30)
    ...
    print("\nJ × B radial acceleration contribution (m/s²):")
...
plt.tight_layout()
plt.show()
plt.savefig('JxB_profile_v7.3.png')

print("✅ v7.3 complete! Share the new J×B radial averages and rotation curve summary.")
