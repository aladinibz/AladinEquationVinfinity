...
# Separate geometry for each staggered component
...
for step in range(steps):
    ...
    # Edge EMFs from HLLD star states (cell-centered approximation for stability)
    Ex = -(vy * Bz_c - vz * By_c)
    Ey = -(vz * Bx_c - vx * Bz_c)
    Ez = -(vx * By_c - vy * Bx_c)
...
print("\n✅ v33.3 complete! HLLD Star-State EMFs implemented in CT block.")
