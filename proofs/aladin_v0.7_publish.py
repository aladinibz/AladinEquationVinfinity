"""
ALADIN Plasma Stability Law v0.7 — FULL 3D PUBLISH-READY (FINAL FIX)
import time added — no more runtime print error
...
import time  # FIXED: added missing import for time.time()
...
mu0 = 4 * np.pi * 1e-7
c = 3e8
a_initial = 1.0  # initial radius scale for ideal mode comparison
rho_0 = 1.745e12
gamma = 5/3
eta = 1e-5
eta_divB = 0.2
...
n_steps = 1000  # small for test — increase to 5000/10000 for full publish
save_every = 200
