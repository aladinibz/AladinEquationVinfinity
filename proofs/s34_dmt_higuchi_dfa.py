...
raw=mne.io.read_raw_bdf('data/raw_bdf/S34-DMT.bdf',preload=True)
...
a1.plot(t,hfd_v,color='red');a1.axvline(41,color='green',ls='--');a1.set_ylabel('HFD');a1.set_title('S34-DMT: Higuchi FD')
a2.plot(t,dfa_v,color='blue');a2.axvline(41,color='green',ls='--');a2.set_xlabel('Time (s)');a2.set_ylabel('DFA');a2.set_title('S34-DMT: DFA')
plt.tight_layout();plt.savefig('s34_dmt_hfd_dfa.png',dpi=300,bbox_inches='tight');plt.close()
print("Plot saved: s34_dmt_hfd_dfa.png")
