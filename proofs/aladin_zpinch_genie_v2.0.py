...
from scipy.special import j0  # Bessel J0 for radial sausage seed
...
history = {"E_total": [], "genie_amp": [], "C_mean": [],
           "T_mean": [], "energy_drift": [], "max_v_over_c": [],
...
while step < MAX_STEPS:
    ...
    accel = lap_now - (f_res/c)**2*genie_phi - 0.005*genie_phi**3 + source_genie
