...
print("🚀 ALADIN v1.6 – 500k steps – BESSEL J0 FIX ONLY")
print("Original code + Bessel J₀(kr) radial seed on sausage – symmetry still single kink")
...
# Keep original single kink seed (no multi-mode yet)
...
progress_bar = tqdm(total=MAX_STEPS, desc="ALADIN v1.6 – 500k steps – BESSEL J0 FIX")
...
print("Bessel seed + original kink active – check sausage band and m=1 power!")
