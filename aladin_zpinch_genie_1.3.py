...
# ╔════════════════════════════════════════════════════════════════════════════╗
# ║                  ALADIN v1.3 – 50,000 steps – MAXIMUM OVERDRIVE             ║
# ║  (128³ grid, extreme dt ramp, Majorana domination, 43 Hz + spectra)         ║
# ╚════════════════════════════════════════════════════════════════════════════╝

TEST_MODE = True

GRID_SIZE = 128
MAX_STEPS = 50000          # 50k steps – full maximum overdrive
dt_max    = 3e-5           # 30 µs max step size
CFL       = 0.50           # aggressive but monitored

print("🚀 ALADIN v1.3 – 50,000 steps – MAXIMUM OVERDRIVE MODE")
...
progress_bar = tqdm(total=MAX_STEPS, desc="ALADIN v1.3 – 50k steps – maximum overdrive")
...
while t < t_max and step < MAX_STEPS:
    ...
    if current_amp > 0.8:
        local_damping *= 3.0  # very strong emergency damping
...
# =============================================================================
# POST-PROCESSING – robust version
# =============================================================================
print("\n" + "="*80)
