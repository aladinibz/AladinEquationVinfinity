...
Full HLLD + CT + Primitive Recovery + Cylindrical Conservation + Modal Analysis
"""
...
Bth[:, :-1, :] = Bth_cc[:, :, np.newaxis]   # Fixed shape
...
plt.title('ALADIN v1.6.2 — Complete Fixed Version')
plt.legend()
plt.grid(True)
plt.savefig('aladin_plots/v1.6.2_final.png', dpi=300, bbox_inches='tight')
plt.show()

print("\n✅ v1.6.2 Complete! Run finished.")
