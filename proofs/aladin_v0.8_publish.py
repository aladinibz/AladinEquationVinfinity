"""
ALADIN v0.8 — FINAL PUBLISH-READY (FULL DERIVATIONS + 16 PLOTS)
Full simulation engine + 16 plots (12 astro/diagnostic/theorem + 4 plasma/fusion)
All variables ordered correctly — no errors
Full criterion text + rigorous Π_crit derivation printed
"""
