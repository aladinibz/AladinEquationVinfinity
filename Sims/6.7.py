...
print("🌌 Plasma Cosmology v6.7 — 128³ A100 GPU + NaN-proof Cooling + CR Diffusion")
...
print("✅ v6.7 complete! Share the new rotation curve shapes, Bmax/vmax, energy drifts, and any early min/max values you see before NaNs.")
