...
GRID_SIZE = 128
MAX_STEPS = 900000         # 900k – overnight push
dt_max    = 1.2e-4
CFL       = 0.75

print("🚀 ALADIN v1.9 FIXED – 900k steps – MEMORY & CRASH-PROOF")
print("Downsampled history every 1000 steps + early checkpoints – should survive!")
...
# Multi-mode kink seed (symmetry breaker)
m_kink = [1, 2, 3, 5, 8]
for m in m_kink:
...
# 43 Hz detection with bandpass – skip if history too short
if len(genie_center_history) > 33:  # padlen safety
