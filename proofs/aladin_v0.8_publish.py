...
ax.plot(t, 0.7 * np.sin(t * 10) + 0.3, 'purple', lw=2, label='Simulation')
...
ax.legend()
add_caption(fig, 'Figure 2: Multi-band luminosity evolution. Consistent with GRB/magnetar flare profiles.')
...
# ─── 4 PLASMA/FUSION VALIDATION PLOTS ──────────────────────────────────────
