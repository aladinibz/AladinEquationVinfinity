...
# Common n_fft for all PSDs (aligns frequencies)
n_fft = 2048
...
plt.title("Subject 31 — Rest vs Deep PSD",fontsize=18)
plt.xlabel("Freq [Hz]"); plt.ylabel("Power (log)")
plt.legend(fontsize=12); plt.grid(alpha=0.4); plt.tight_layout()
plt.savefig("plots/subject_31_rest_vs_deep_psd.png",dpi=1200)
print("Saved: plots/subject_31_rest_vs_deep_psd.png")
