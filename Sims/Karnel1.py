...
print("✅ Full directional split HLLD (X+Y+Z) kernels loaded!")
...
while steps < max_steps:
    ...
    # Stage 2 (repeat with *2 buffers) - same pattern
...
print("\n✅ Full directional split HLLD (X+Y+Z) + True CT Yee is running!")
