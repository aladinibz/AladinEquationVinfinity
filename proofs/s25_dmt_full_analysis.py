"""
S25-DMT Breakthrough — Complete Analysis with 12 Proof Plots
...
Downloads S25_DMT.bdf directly from repo
"""
...
plt.ylabel('F(q,s)')
plt.grid(True)
plt.savefig('plots/s25_dmt_fluctuation_functions.png', dpi=300)
plt.close()
...
plt.ylabel('h(q)')
plt.grid()
plt.savefig('plots/s25_dmt_hq_curve.png', dpi=300)
plt.close()
...
plt.ylabel('f(α)')
plt.grid()
plt.savefig('plots/s25_dmt_singularity_spectrum.png', dpi=300)
plt.close()
...
plt.title('Δα Collapse (S25-DMT)')
plt.xlabel('Time (s)')
plt.ylabel('Δα')
plt.grid(True)
plt.legend()
plt.savefig('plots/s25_dmt_delta_alpha_timecourse.png', dpi=300)
plt.close()
...
plt.title('Δα vs Gamma (S25-DMT)')
plt.xlabel('Time (s)')
plt.tight_layout()
plt.savefig('plots/s25_dmt_delta_alpha_gamma_43vs40.png', dpi=300)
plt.close()
...
plt.axvline(41, c='red', ls='--', lw=3, label='t=41 s')
plt.title('AAFT Surrogate Test (S25-DMT)')
plt.xlabel('Time (s)')
plt.ylabel('Δα')
plt.legend(fontsize=10)
plt.grid(True, alpha=0.3)
plt.savefig('plots/s25_dmt_delta_alpha_aaft_surrogate.png', dpi=300)
plt.close()
...
plt.ylabel('Δα')
plt.grid(True, alpha=0.3)
plt.savefig('plots/s25_dmt_delta_alpha_pre_post_ci.png', dpi=300)
plt.close()
...
plt.grid(True, alpha=0.3)
plt.savefig('plots/s25_dmt_gamma43_pre_post_ci.png', dpi=300)
plt.close()
...
plt.title('PSD Pre vs Post t=41 s Switch (S25-DMT)')
plt.axvspan(40, 50, color='gold', alpha=0.15, label='40–50 Hz band')
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s25_dmt_psd_pre_post.png', dpi=300)
plt.close()
...
plt.title('Z-scores at t≈41 s across surrogates (S25-DMT)')
plt.xlabel('Z-score')
plt.ylabel('Count')
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig('plots/s25_dmt_zscore_histogram.png', dpi=300)
plt.close()
