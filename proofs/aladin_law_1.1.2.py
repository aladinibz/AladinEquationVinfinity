"""
ALADIN v1.1.2 — Fixed Constrained Transport (CT)
128³ Locked
"""
...
for J0 in J0_list:
    for rho0 in rho0_list:
        ...
        B_theta[:, :-1, :] = B_theta_cc[:, :, np.newaxis]   # simple staggering
        B_z[:, :, :-1] = 2800.0
        ...
        for step in tqdm(range(n_steps), leave=False, desc=f"J0={J0:.1e}"):
            ...
            # Cell-centered for calculations
            ...
            # Resistive diffusion (on cell-centered)
