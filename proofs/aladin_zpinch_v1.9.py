...
# ╔════════════════════════════════════════════════════════════════════════════╗
# ║                  ALADIN v1.9 – 1,000,000 steps – SYMMETRY BREAKER MARATHON ║
# ║  (128³ grid, Bessel J₀(kr) + multi-mode kink seed, zero diffusion)         ║
# ╚════════════════════════════════════════════════════════════════════════════╝

GRID_SIZE = 128
MAX_STEPS = 1000000        # 1 MILLION steps – overnight marathon
dt_max    = 1.2e-4
CFL       = 0.75

print("🚀 ALADIN v1.9 – 1M steps – SYMMETRY BREAKER MARATHON")
print("Bessel J₀(kr) + multi-mode kink seed (m=1–8) to break symmetry & trigger coupling!")
print(f"dt_max = {dt_max:.1e}, CFL = {CFL}, expected runtime ~6–10 hours on A100")
...
# =============================================================================
# PARAMETERS – v1.9 repo-aligned + symmetry breaker
# =============================================================================
...
m_kink = [1, 2, 3, 5, 8]  # low to medium modes
for m in m_kink:
...
progress_bar = tqdm(total=MAX_STEPS, desc="ALADIN v1.9 – 1M steps – SYMMETRY BREAKER MARATHON")
...
while t < t_max and step < MAX_STEPS:
    ...
    majorana_backreaction = 1e-3 * ferm_total_mass  # stronger – fermions push plasma
