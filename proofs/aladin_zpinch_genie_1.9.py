...
GRID_SIZE = 128
MAX_STEPS = 700000         # 700k steps – balanced & stable
dt_max    = 1.2e-4
CFL       = 0.75

print("🚀 ALADIN v1.9 – 700k steps – CRASH-RESISTANT VERSION")
print("Skip history first 10k + downsample every 5000 + checkpoint every 10k + RAM monitor")
...
progress_bar = tqdm(total=MAX_STEPS, desc="ALADIN v1.9 – 700k steps – CRASH-PROOF")
...
try:
    while t < t_max and step < MAX_STEPS:
        ...
        # Downsample history every 2000 steps + skip first 5000
...
# =============================================================================
print("\n" + "="*80)
print("ALADIN v1.9 – 700,000 steps – FINAL ANALYSIS")
print("="*80)
...
if len(genie_center_history) > 33:
    ...
    plt.grid(alpha=0.3)
    plt.legend()
    plt.savefig('plots/plot35_filtered_43hz_signals_700k.png', dpi=200)
    plt.close()
    print("Saved: plots/plot35_filtered_43hz_signals_700k.png")
else:
...
plt.ylabel('Power')
plt.title('Fermion Mass z-Spatial Power Spectrum – 700k steps')
plt.legend()
plt.grid(alpha=0.3, which='both')
plt.savefig('plots/plot43_fermion_mass_spatial_spectrum_700k.png', dpi=200, facecolor='black')
plt.close()
print("Saved: plots/plot43_fermion_mass_spatial_spectrum_700k.png")
...
plt.ylabel('Power')
plt.title('Azimuthal Power Spectrum – Kink Detection (700k)')
plt.axvline(1, color='red', ls='--', label='m=1 kink')
plt.legend()
plt.grid(alpha=0.3)
plt.savefig('plots/plot45_azimuthal_power_kink_700k.png', dpi=200, facecolor='black')
plt.close()
print("Saved: plots/plot45_azimuthal_power_kink_700k.png")

print("\nALADIN v1.9 – 700,000 steps finished!")
